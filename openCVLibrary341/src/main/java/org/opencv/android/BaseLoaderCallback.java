    ...
    public void onManagerConnected(int status)
    {
        switch (status)
        {
            ...
            case LoaderCallbackInterface.MARKET_ERROR:
            {
                ...
                androidx.appcompat.app.AlertDialog MarketErrorMessage = new AlertDialog.Builder(mAppContext).create();
            ...
            default:
            {
                ...
                InitFailedDialog.setButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE, "OK", new OnClickListener() {
